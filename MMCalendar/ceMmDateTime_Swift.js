...
// Make classes globally available for JavaScriptCore (Swift compatibility)
this.ceDateTime = ceDateTime;
this.ceMmDateTime = ceMmDateTime;
this.ceMmChronicle = ceMmChronicle;